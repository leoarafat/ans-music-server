...
const releaseSongs = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield catalog_music_service_1.catalogMusicService.releaseSongs(req.query);
...
const tracks = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield catalog_music_service_1.catalogMusicService.tracks(req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: 'Successful',
