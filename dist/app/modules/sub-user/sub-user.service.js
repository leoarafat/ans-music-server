...
const sub_user_model_1 = __importDefault(require("./sub-user.model"));
//!
const registrationSubUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isEmailExist = yield sub_user_model_1.default.findOne({ email });
    if (isEmailExist) {
...
const activateUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existUser = yield sub_user_model_1.default.findOne({ email });
    if (existUser) {
        throw new ApiError_1.default(400, 'Email is already exist');
    }
    const user = yield sub_user_model_1.default.create({
        name,
        email,
        password,
    });
...
const getAllUsers = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield sub_user_model_1.default.find({ user: id });
    return users;
});
//!
const getSingleUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield sub_user_model_1.default.findById(id);
    return result;
});
//!
const updateUser = (id, req) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield sub_user_model_1.default.findOne({ _id: id });
    const { files } = req;
    ...
    const result = yield sub_user_model_1.default.findOneAndUpdate({ _id: id }, Object.assign(Object.assign({}, userData), { image: `${config_1.default.base_url}/${imageFile.path}`, nidFront: `${config_1.default.base_url}/${nidFrontImage.path}`, nidBack: `${config_1.default.base_url}/${nidBackImage.path}` }), {
        new: true,
    });
    if (result) {
...
const deleteUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield sub_user_model_1.default.findByIdAndDelete(id);
    return result;
});
//!
const login = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, password } = payload;
    const isUserExist = yield sub_user_model_1.default.isSubUserExist(email);
    if (!isUserExist) {
        throw new ApiError_1.default(404, 'SUb User does not exist');
    }
    if (isUserExist.password &&
        !(yield sub_user_model_1.default.isPasswordMatched(password, isUserExist.password))) {
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield sub_user_model_1.default.isSubUserExist(userId);
    if (!isUserExist) {
        throw new ApiError_1.default(403, 'Sub User does not exist');
    }
    //generate new token
...
const changePassword = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield sub_user_model_1.default.findOne({ _id: user === null || user === void 0 ? void 0 : user.userId }).select('+password');
    if (!isUserExist) {
        throw new ApiError_1.default(404, 'User does not exist');
    }
    if (isUserExist.password &&
        !(yield sub_user_model_1.default.isPasswordMatched(oldPassword, isUserExist.password))) {
        throw new ApiError_1.default(402, 'Old password is incorrect');
    }
    isUserExist.save();
});
exports.SubUserService = {
    getAllUsers,
    getSingleUser,
    updateUser,
    deleteUser,
