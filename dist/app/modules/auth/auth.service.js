...
const forgotPass = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findOne({ _id: payload.id }, { _id: 1, role: 1 });
    if (!user) {
...
const resetPassword = (payload, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.default.findOne({ _id: id }, { _id: 1 });
    if (!user) {
    ...
    yield user_model_1.default.updateOne({ _id: id }, { password });
});
exports.AuthService = {
    loginUser,
    refreshToken,
