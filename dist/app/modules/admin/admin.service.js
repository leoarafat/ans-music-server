...
//!
const approveSingleMusic = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (findSingleSong) {
        const result = yield single_model_1.SingleTrack.findOneAndUpdate({ _id: id }, Object.assign(Object.assign({}, musicData), { isApproved: 'approved' }), {
            new: true,
            runValidators: true,
        })
            .populate('label')
    ...
    if (findAlbumSong) {
        const result = yield album_model_1.Album.findOneAndUpdate({ _id: id }, Object.assign(Object.assign({}, musicData), { isApproved: 'approved' }), {
            new: true,
            runValidators: true,
        })
            .populate('label')
