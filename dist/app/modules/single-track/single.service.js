...
const myAllMusic = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const albumSong = new QueryBuilder_1.default(album_model_1.Album.find({ user: id })
        .lean()
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
    ...
    const singleSongData = singleTracks === null || singleTracks === void 0 ? void 0 : singleTracks.map(song => {
        var _a;
    ...
    const albumSongData = albums === null || albums === void 0 ? void 0 : albums.flatMap(album => album.audio.map(audioItem => {
        var _a;
        return (Object.assign(Object.assign({}, album), { audio: (_a = (0, url_modifier_1.updateImageUrl)(audioItem.path)) === null || _a === void 0 ? void 0 : _a.replace(/\\/g, '/') }));
    }));
