...
const uploadSingle = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(data.primaryArtist.map((artist) => __awaiter(void 0, void 0, void 0, function* () {
        artist.primaryArtistId = (0, uniqueId_1.generateArtistId)();
    })));
    ...
    const result = yield single_model_1.SingleTrack.create(Object.assign(Object.assign({}, data), { audio: {
        ...
        }, image: imageFile.path, labelId: (0, uniqueId_1.generateLabelId)() }));
    return result;
});
const myAllMusic = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield single_model_1.SingleTrack.find({ user: id });
