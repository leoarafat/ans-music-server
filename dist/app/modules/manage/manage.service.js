...
const getPrimaryArtist = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    const artistQuery = new QueryBuilder_1.default(manage_model_1.PrimaryArtist.find({ user: id }), query)
        .search(['primaryArtistName'])
        .filter()
        .sort()
        .paginate()
        .fields();
    const result = yield artistQuery.modelQuery;
    const meta = yield artistQuery.countTotal();
    return {
        meta,
        data: result,
    };
