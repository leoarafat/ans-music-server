...
//   return statistics;
// };
const generateAnalytics = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const singleTrackISRCs = yield single_model_1.SingleTrack.find({ user: id }).distinct('isrc');
        const albumISRCs = yield album_model_1.Album.find({ user: id }).distinct('isrc');
