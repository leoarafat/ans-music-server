...
const getSingleUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedResult = Object.assign(Object.assign({}, result.toObject()), { image: (0, url_modifier_1.updateImageUrl)(result.image).replace(/\\/g, '/') });
...
// };
//!
const mySuccessRelease = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    const singleSongs = new QueryBuilder_1.default(single_model_1.SingleTrack.find({ user: id, isApproved: 'approved' })
        .populate('user')
        .populate('label')
    ...
    const albumSongs = new QueryBuilder_1.default(album_model_1.Album.find({ user: id, isApproved: 'approved' })
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
        .search(['releaseTitle'])
        ...
        .paginate()
        .fields();
    const albums = yield albumSongs.modelQuery;
...
//!
const myPendingRelease = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    const singleSongs = new QueryBuilder_1.default(single_model_1.SingleTrack.find({ user: id, isApproved: 'pending' })
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
        .search(['releaseTitle'])
        ...
        .fields();
    const singleTracks = yield singleSongs.modelQuery;
    const albumSongs = new QueryBuilder_1.default(album_model_1.Album.find({ user: id, isApproved: 'pending' })
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
        .search(['releaseTitle'])
...
// };
//!
const myCorrectionRelease = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    // const singleTracks = await SingleTrack.find({ user: id })
    //   .populate('user')
    //   .populate('label')
    //   .populate('primaryArtist');
    const singleSongs = new QueryBuilder_1.default(single_model_1.SingleTrack.find({ user: id })
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
        .search(['releaseTitle'])
        ...
        .fields();
    const singleTracks = yield singleSongs.modelQuery;
    const albumsSong = new QueryBuilder_1.default(album_model_1.Album.find({ user: id })
        .populate('user')
        .populate('label')
        .populate('primaryArtist'), query)
        .search(['releaseTitle'])
        ...
        .paginate()
        .fields();
    const albums = yield albumsSong.modelQuery;
    ...
    const singleSongData = filteredSingleTracks.map(song => (Object.assign(Object.assign({}, song), { audio: (0, url_modifier_1.updateImageUrl)(song.audio.path).replace(/\\/g, '/'), image: (0, url_modifier_1.updateImageUrl)(song.image).replace(/\\/g, '/') })));
    const albumSongData = filteredAlbums.flatMap(album => album.audio.map(audioItem => (Object.assign(Object.assign({}, album), { audio: (0, url_modifier_1.updateImageUrl)(audioItem.path).replace(/\\/g, '/'), image: (0, url_modifier_1.updateImageUrl)(album.image).replace(/\\/g, '/') }))));
