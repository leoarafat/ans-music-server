...
const mySuccessRelease = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield user_service_1.UserService.mySuccessRelease(id, req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const myPendingRelease = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield user_service_1.UserService.myPendingRelease(id, req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: ' successfully',
...
const myCorrectionRelease = (0, catchasync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield user_service_1.UserService.myCorrectionRelease(id, req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: ' successfully',
